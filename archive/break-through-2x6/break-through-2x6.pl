...
legal(xplayer, moves(X1, Y1, X2, Y2)) :- true(control(xplayer)), true(cell(X1, Y1, xplayer)), 
                                          yplusplus(Y1, Y2), xplusplus(X1, X2), \+ true(cell(X2, Y2, xplayer)).


legal(xplayer, moves(X1, Y1, X2, Y2)) :- true(control(xplayer)), true(cell(X1, Y1, xplayer)),
                                            yplusplus(Y1, Y2), xplusplus(X2, X1), \+ true(cell(X2, Y2, xplayer)).
...
legal(oplayer, moves(X1, Y1, X2, Y2)) :- true(control(oplayer)), true(cell(X1, Y1, oplayer)),
                                            yplusplus(Y2, Y1), xplusplus(X1, X2), \+ true(cell(X2, Y2, oplayer)).



legal(oplayer, moves(X1, Y1, X2, Y2)) :- true(control(oplayer)), true(cell(X1, Y1, oplayer)),
                                            yplusplus(Y2, Y1), xplusplus(X2, X1), \+ true(cell(X2, Y2, oplayer)).
