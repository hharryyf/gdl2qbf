...
%parse_gdl_term_string(String, '') :- write("ECLiPSe: parse_gdl_term_string("), write(String), write(") FAILED"), nl.
...
%parse_gdl_term_list_string(String, '') :- write("ECLiPSe: parse_gdl_term_list_string("), write(String), write(") FAILED"), nl.
